...
Period is defined for a pair of granularities $(G, H)$. In Definition 6, the period is defined by $P$, which is the number of granules of $G$ contained in $R$ granules of $H$.. Thanks for pointing out the inconsistencies. We have now made it consistent.
