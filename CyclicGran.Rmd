...
H(j) = \bigcup_{i \in S_{j \mod R}}G(P*\lfloor j/R \rfloor + i), 
\end{equation}, 
...
Q_{day, month}(439) & = L(439 - \sum_{w=0}^{14-1}\vert T_{w \mod 12} \vert)\quad since \quad 439 \in \quad month(14)\\
& = L(439 - \sum_{w=0}^{13}\vert T_{w \mod R'} \vert)\\
