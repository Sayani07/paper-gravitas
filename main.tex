...
{\centering \includegraphics[width=1\linewidth]{Figs/groups_periodically} 

}

\caption{Linear granularity $B$ groups periodically into linear granularity $G$ with $P = 5$ and $R = 2$, alternating between combining 2 and 3 granules of $B$.}\label{fig:group-periodical}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{smart_meter10 }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{smart_meter10 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(customer_id }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{10017936}\NormalTok{))}\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cricket_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{gran_obs}\NormalTok{(}\StringTok{"field"}\NormalTok{, }\StringTok{"over"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cricket_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{gran_obs}\NormalTok{(}\StringTok{"dot"}\NormalTok{, }\StringTok{"over"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
