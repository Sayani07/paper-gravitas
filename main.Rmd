...
\todo[inline]{What does "full-integer" mean? It might be the case that we do not always
...
arbitrary subset of (possibly non contiguous) integers and could be used to identify granules. The author has introduced the definition of "labeled granularity" in @Ning2002-tf which could be added after definition of linear granularity to clarify this. }
