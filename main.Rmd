...
knitr::include_graphics("Figs/circular-illustration.png")
```
...
```{r aperiodic-example, echo=FALSE,out.width = "100%",fig.cap="Terminology and intuition of aperiodic cyclic granularities are shown. Panel a shows the time domain distributed as linear granularities Day, Semester, Semester Week, within semester breaks, in-session and aperiodic cyclic granularity Week-of-semester. $A(B, M)$ consists of three categories, 1, 2 and 0 corresponding to within semester breaks, in-session and non-semester period respectively. Panel b depicts the intuition through a measuring tape analogy which needs to be folded at different points every year since $M1$ and $M2$ will fall in different weeks."}
