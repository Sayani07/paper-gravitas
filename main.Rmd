...
Let G be a periodic linear granularity, not equal to the bottom granularity, with k(BG,G) as the period length of the bottom granularity with respect to linear granularity G.
