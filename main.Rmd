...
**Notation:  Hierarchy table** Let H: $(G, C, k, n)$ be a hierarchy model containing m linear granularities. $G_{i}$ represents the linear granularity of order i and $k_{i}$å represents the period length of $$G_{i}$$ with respect to $$G_{i+1}$$ and $C_{l,m}$ represents the circular granularity that relates linear granularity of order l and m, with $\forall l,m \in n, l<m$. 
