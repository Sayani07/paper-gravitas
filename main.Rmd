...
$T_w$ are the sets of indices of BG describing $AG_w$ such that $AG(w) = \bigcup_{z \in T_w}BG(z)$,  
...
The linear granularities G, H, G1 and G2 considered in the definitions of both circular and aperiodic granularities are periodic with respect to the bottom granularity. The only difference is G, H have regular mapping, whereas, G1 and G2 have irregular mapping with respect to BG.
