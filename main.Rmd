...
```{r table_accessor2}
kable(tibble::tibble(
  `linear granularities`  = c("second", "minute", "hhour", "hour", "day", "week", "month", "quarter"),
  `Conversion factor` = c(60, 30, 2, 24, 7, "aperiodic", 3, 1), 
  `Single-order-up accessors` = c("second_minute", "minute_hhour", "hhour_hour", "hour_day", "day_week", "week_month", "month_quarter", 1)), format = "markdown")
```

The table suggests that one hour is composed of 60 minutes, 1 day is composed of 24 hours, 1 quarter is composed of 3 months, 1 semester is consists of 2 quarters and 1 year is made up of 2 semesters. These partitions are periodic, since the number of finer units within each of these coarser units are same always.
