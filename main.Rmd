...
the bias in the estimation of $f(x)$ does not depend directly on the sample size($n$), but only on band width $h$, unless $h$ is chosen as a function of $n$. However, the variance of the $f(x)$ is $(1/nh)\int K(t)^2dt$ is a function of n.
