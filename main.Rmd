...
**Hierarchy table** Let $H_n: (G, C, P)$ be a hierarchy table containing $n$ linear granularities. $G_{l}$ represents the linear granularity of order l and $P(l,m)$ represents the period length of $G_{l}$ with respect to $G_{m}$ and $C_{G(l),G(m)}$ represents the cyclic granularity that relates linear granularity of order l and m, $\forall l,m \in {1, 2, \dots,n}$ and $l<m$.
...
We refer to granularities which are nested within multiple levels of the hierarchy table as _multiple-order-up_ granularities and those concerning a single level as _single-order-up_ granularities.
