...
**Example:** Let us use Equations \ref{eq:multifromsingle-quasi1} and \ref{eq:multifromsingle-quasi2} to compute the multiple-order-up granularity hour_month and day_year for the Gregorian calendar considered.
