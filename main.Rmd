...
Difference in runs across overs are likely to be negative if good fielding has an impact on the runs scored in the subsequent overs. --> Dismissals in previous over can lead to a batsman being either defensive or play more vulnerable. Figure \ref{fig:field} shows that no dismissals in the previous over will lead to a higher median and quartile spread of run rates compared to the case when there has been at least one dismissals.
