...
```{r circular-dow,echo=FALSE,out.width = "100%",fig.cap=" Circular granularities illustrated through linear (a) and stack (b) display of time. The granules that overlap represent same time domain in the linear display and same category in the stack display. Circular granularities day-of-week ($C_{B, G}$) and day-of-fortnight ($C_{B, H}$) have repeating patterns unlike $B$, $G$ or $H$ which gets manifested more clearly through a stack display of time."}
knitr::include_graphics("Figs/circularex.png")
```
...
knitr::include_graphics("Figs/quasiex.png")
