...
A linear granularity $G$ is finer than a linear granularity $H$, denoted $G \preceq H$, if for each index $i$, there exists an index $j$ such that
\[
G(i) \subset H(j).
\]
\end{definition}.
