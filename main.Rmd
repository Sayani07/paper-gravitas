...
```{r}
data_sm1 %>% granplot("day_week", "hour_day", "general_supply_kwh", plot_type = "decile")

data_sm2 %>% granplot("day_week", "hour_day", "general_supply_kwh", plot_type = "decile")

data_sm3 %>% granplot("day_week", "hour_day", "general_supply_kwh", plot_type = "decile")
