...
suggests that levels of $C_1$, that is $A_i$'s which are placed in close proximity are to be compared against each other and each level of $B_j$ represent a group. When $A_i$ mapped to facets and $B_j$ is mapped to $x$ axis, distributions are compared across levels of $B_j$ and levels if $A_i$ start acting as a group. However, the variables used in the layers are the same, the difference in mapping emphasizes different behavior of the variables.
