...
Day-of-Month: & $Q_1(z)$ && $P_1=31, 30, 29, 28$\\
Hour-of-Month: & $Q_2(z)$ && $P_2=24*31, 24*30, 24*29, 24*28$\\
Day-of-Year: & $Q_3(z)$ && $P_3=366, 365$\\
Week-of-Month: & $Q_4(z)$ && $P_4=5, 4$\\ 
\bottomrule
\end{tabular}
\end{center}
...
Since G' is periodical with respect to BG, from definition \ref{def:periodical} the following still holds true:

- $B \trianglelefteq G'$
- there exist $R', P' \epsilon Z+$ such that if $G'(w) = \bigcup_{z \in T_w}B(z)$ and $G(w + R') \neq \phi$ then $G'(w + R') = \bigcup_{z \in T_w}B(z + P')$ and hence $G'(w) = \bigcup_{z \in T_w \mod R'}B(P'*\lfloor w/R' \rfloor + z)$,  where P' denotes the period of the grouping $(B, G')$.
