...
Consider a hierarchy table laying out the structure of all temporal granularities we are interested to look at. The hierarchy table consists of three columns: 
