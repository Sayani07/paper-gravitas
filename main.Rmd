...
With huge amount of data currently available, it is important to visualize the distribution of the time series variable rather than any particular statistic. But which ditribution plot to draw, is based on what features of the distribution we are interested to look at, or how much display space is available to us.
