...
knitr::include_graphics("Figs/quasi-ex.png")
...
**Order** of a linear granularity can be comprehended as the level of coarseness associated with a linear granularity. For example, for two linear granularities $G$ and $H$, if $G$ _groups into_ or _finer than_ $H$ or $H$ is composed of higher number of granules of the bottom granularity than $G$, then $G$ is of lower order than $H$. In any hierarchy table, linear granularities are arranged from lowest to highest order.
