...
For example, due to the uneven length of months, we need to use the altering-tick operation to compute months from days.  Let us consider a granularity "pseudomonth" which computes months only for non-leap years by grouping 31 days, and then shrink April, June, September and November by 1 day, and shrink February by 3 days [@Ning2002-tf].
