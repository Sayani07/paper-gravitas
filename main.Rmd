...
Often we partition time into years, months, weeks, days and so on in a hierarchical manner to relate it to data. Such discrete abstractions of time can be thought of as linear time granularities [@aigner2011visualization]. Providing a formalism to this abstraction is important to model a time series across differently grained temporal domains.
