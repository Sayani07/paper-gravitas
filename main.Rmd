...
### Computation of multiple-order from single-order

#### All single order granularities are circular
...
#### Single order granularities are circular or aperiodic

#### All single order granularities are circular

### Computation of single-order from multiple-order
...
<!-- Computation of multiple-order-up granularities will differ if the units in the hierarchy table are periodic or aperiodic. We split the method of computation into two cases - one concerning all periodic single-order-up granularities and the second with mixed single-order-up granularities. -->
