...
The hierarchical structure of time creates a natural nested ordering. Hence, given a hierarchy we can define **single-order-up** and **multiple-order-up** granularities. We refer to granularities which are nested within multiple levels as **multiple-order-up** granularities. We take the help of Mayan calendar to illustrate this. In "Mayan" calendar, one day was referred to as 1 kin and the calendar was structured as follows: 
...
Examples of **multiple-order-up**  granularities can be kin of the tun or kin of the baktun whereas examples of single-order-up granularities, which are nested within single levels may include kin of the uinal, uinal of the tun etc. 
...
Suppose, the index of the tsibble is 
...
kable(tibble::tibble(
  ...
  `Single-order-up accessors` = c("second_minute", "minute_hhour", "hhour_hour", "hour_day", "day_week", 1)
), format = "markdown")
```
...
kable(tibble::tibble(
  ...
  `Single-order-up accessors` = c("second_minute", "minute_hhour", "hhour_hour", "hour_day", "day_month", "month_quarter", 1)
), format = "markdown")
```
