...
#                              "Chennai Super Kings"))%>%
#   create_gran("inning_match", hierarchy_model) %>% create_gran("over_inning", hierarchy_model)
...
cricket_tsibble %>% gran_obs("over", "fielding_wckts")


cricket_data_ts <- cricket_tsibble %>% 
  ...
  cricket_data_ts %>% prob_plot( "over","field",
                               hierarchy_model,
