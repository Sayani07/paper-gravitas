...
The entire distribution can be visualized or some contextual summary statistics can be visualised to emphasize certain properties of the distribution. These properties can throw light on central tendency, skewness, kurtosis, variation of the distribution. They can also be useful in detecting extreme behavior or anolmalies in the dataset.




hich ditribution plot to draw, is based on what features of the distribution we are interested to look at, or how much display space is available to us.
