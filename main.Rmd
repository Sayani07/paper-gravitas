...
Re-occurances in time can also happen due to completely irregular mapping between linear granularities. Some public and school holidays repeat every year, but the time period on which they appear might vary from year to year. For example, U.S labour day is the first Monday in September and U.S. Memorial Day is the last day in May. 



A classic example can be that of Easter. 
