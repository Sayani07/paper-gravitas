...
**Definition: Aperiodic granularity** An aperiodic granularity A(G, BG) that relates linear granularities G and bottom granularity BG, where G is periodical with respect to BG, if

$A_{BG, G}(z) = BG(z - \sum_{j=0}^{k-1}\vert S_{j \mod R} \vert)$ for $z \in S_k$,

where,
z denotes the index set,  
P and R denotes the period of the granularity BG and number of granules of G in each period of BG,  
