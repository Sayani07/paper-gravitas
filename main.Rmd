...
A \textbf{quasi-circular granularity} $Q_{B, G'}$ relates linear granularity $G'$ and bottom granularity $B$ if\todo{This is not a condition. What is $Q$ used for?}
...
An \textbf{aperiodic cyclic granularity} $A_{B, M}$ relates a linear granularity $M$ to the bottom granularity $B$, if\todo{This is not a condition. What is $A$ used for?}
