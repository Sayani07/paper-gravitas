...
cricket_data %>% prob_plot("over", "lag_field",
  ...
  response = "run_rate",
  plot_type = "violin",
) + ggtitle("") + geom_boxplot(width = 0.5, aes(colour = lag_field)) + ylim(0, 4.5)
```
