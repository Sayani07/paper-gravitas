...
## Summarizing properties of the distribution
...
The layered grammar of graphics proposed by [@Wickham2009-pk], which is a modification over the former, suggests that graphics are made up of distinct layers of grammatical elements. Briefly, the grammatical elements of any plot are as follows:
...
- Geometric objects: examples can include boxplot, letter value, violin, ridge, highest density region plots
- Facet:  $B_j(s)$
