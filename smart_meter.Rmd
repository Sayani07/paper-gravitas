...
```{r cust3_hd_dw, fig.cap="Violin plots of hourly consumption across different day of the week for the second household."}
...
```{r cust1_dw_my,fig.cap="this is a caption"}
library(ggplot2)
...
```{r cust3_dw_my, fig.cap="this is a caption"}
library(ggplot2)
