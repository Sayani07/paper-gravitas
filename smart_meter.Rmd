...
data_sm3 %>% granplot("day_week", "hour_day", "general_supply_kwh", plot_type = "violin") +
  #ggtitle("Violin plot of energy consumption across hour-of-day and day-of-week for Household 2") +
  scale_x_discrete(breaks = seq(0,23,3)) +
  ggtitle("") +
  scale_y_continuous(breaks = seq(0, 1.5, 0.25))
```
...
data_sm1 %>% granplot("month_year", 
                      "day_week", 
                      response = "general_supply_kwh", plot_type = "lv") +  ggtitle("") +  #ggtitle("LV plot of energy consumption across days-week by month-year for Household 1") +
  scale_y_continuous(breaks = seq(0, 1.5, 0.25))
```
...
data_sm3 %>% granplot("month_year", "day_week", response = "general_supply_kwh", plot_type = "lv") +  ggtitle("") +
  #ggtitle("LV plot of energy consumption across days of week by month of years for Household 2") + 
  scale_y_continuous(breaks = seq(0, 1.5, 0.25))
```
...
data_sm1 %>% 
  ...
  #ggtitle("Boxplot plot of energy consumption across days of week by month of years for Household 2") +
  scale_y_continuous(breaks = seq(0, 1.5, 0.25))
```
...
We can keep on slicing and dicing the data similarly and derive more insights about the behavior of these households.
