...
Type I Error. Reject the null hypothesis when there is in fact no significant effect.
...
data <- gravitas:::sim_distharmony1(.data = harmonies[1,], sim_dist =  dist_normal(mu = 2, sigma = 5))
...
harmony_data <- list(dat1, dat2)
response = "general_supply_kwh"

global_harmony <- harmony_data %>%
